...
const getPromotionDetailsById = async (promotionId) => {
  try {
    ...
    console.log(
      "Error in customerRepository getPromotionDetailsById" + e.message
    );
    throw e;
  }
};
...
const getUsers = async (promotionId) => {
  try {
    ...
    console.log("Error in customerRepository getUsers " + e.message);
    throw e;
  }
};
...
const updateTotalUserCount = async (userCount, promotionId) => {
  try {
    ...
    console.log(
      "Error in customerRepository updateTotalUserCount " + e.message
    );
    throw e;
  }
};
